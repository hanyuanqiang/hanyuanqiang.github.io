	...
	Page.prototype={
		...
		create:function(){
			...
			if(this.href){
				...
				var preurl='',nexturl='';
				var pre_1 = this.page-1;
				preurl=this.page==1?this.href+this.page:this.href+(pre_1);
				nexturl=(this.page+this.num)>this.count?this.href+this.count:this.href+(this.page+this.num);
